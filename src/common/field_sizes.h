...
const unsigned MAX_USERNAME_LEN = 50; /* including terminating NUL char */
const unsigned MIN_USERNAME_LEN = 1;
...
const unsigned MAX_CHARNAME_LEN = 50;
const unsigned MIN_CHARNAME_LEN = 1;
